            ...
            <motion.div key={currentNode.id} ref={currentRef} className="relative scroll-mt-20 rounded-[28px] border border-white/70 bg-white/45 p-3 shadow-sm backdrop-blur-sm sm:p-4"
              ...
              {currentNode.type === 'end' && (
                <div className="relative card-hero overflow-hidden p-3 sm:p-4">
                  ...
                  <div className="relative mb-4 rounded-2xl border-2 border-detective-100 bg-[#FFFCF7] p-3 text-center">
                    ...
                    <div className="flex justify-center gap-1.5">
                      {[1, 2, 3, 4, 5].map(n => (
                        <button
                          ...
                          className="text-3xl active:scale-90 hover:scale-110 transition-transform cursor-pointer p-1"
                        >
                          {n <= funStars ? '⭐' : '☆'}
                        </button>
                      ))}
                    ...
                    {funStars > 0 && (
                      <p className="text-xs text-emerald-600 font-bold mt-2">
                        ✓ คุณให้ {funStars} ดาว (แตะดาวอื่นเพื่อแก้ไขคะแนนได้)
                      </p>
                    )}
                  </div>
